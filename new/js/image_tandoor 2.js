   ...
   helper.loadImage = function(src) {
       if (src) {
           ...
           img.onload = function() {
               ...
               helper._config.waterMarkLoaded = false;
   ...
   tools.saturate = {
       ...
       init: function() {
           var jQSaturate = tools.saturate.btn = $(document.createElement(spanStr))
               ...
               .attr('title', 'Click to add saturation brush').html('<i class="fa fa-paint-brush"></i>'),
   ...
   tools.colorPicker = {
       ...
       init: function() {
           ...
           tools.colorPicker.jQPickerToolBox = $(document.createElement('div')).addClass('subtool-holder')
           ...
           jQSlider.slider({
               ...
               change: function(event, ui) {
                   ...
                   config.tolerance = config.sliderPos;
                   tools.colorPicker.applyCPFilter();
               }
           });
       ...
       applyCPFilter: function() {
           var config = tools.colorPicker._config,
               ...
               g = colorData[1],
               b = colorData[2],
               hslArr = helper.rgbToHsl(colorData);
           ...
           for (i = 0; i < l; i += 1, index1 += 4) {
               ...
               if (helper.colorComparison(hslArr, [oriImageData[index1], oriImageData[index1 + 1], oriImageData[index1 + 2]], tolerance)) {
   ...
   //     },
   //     init: function() {
   //         var fileUploaderOverlay = $(document.createElement('input')).attr('type', 'file').on('change',
   // function(e) {
   //                 var reader = new FileReader();
   //                 reader.onload = function(event) {
   ...
   //         tools.overlayUploader.jQOverlayToolBox = $(document.createElement('div')).addClass('subtool-holder')
   //             .append($(document.createElement(spanStr))
   //                 .addClass(sbClass).append($(document.createElement(spanStr))
   //                     .html('Upload overlay:')).append(fileUploaderOverlay))
   //       .append($(document.createElement(spanStr))
   //                 .addClass(sbClass).append($(document.createElement(spanStr))
   ...
   //         tools.zoom.jQZoomToolBox = $(document.createElement('div')).addClass('subtool-holder')
   // .append($(document.createElement(spanStr))
   //             .addClass(sbClass).append($(document.createElement(spanStr))
   ...
   //         tools.magicWand.jQWandToolBox = $(document.createElement('div')).addClass('subtool-holder')
   // .append($(document.createElement(spanStr))
   //             .addClass(sbClass).append($(document.createElement(spanStr))
